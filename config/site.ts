...
const zh = {
  person: {
    ...
    intro: '我是鹿码人，在上海做独立开发。10 年开发经验：前 3 年 Web 前端（JavaScript / TypeScript / Node.js / React / Vue），3 年在喜马拉雅做游戏前端（Phaser.js / Cocos Creator），主导过千万级 DAU 产品的核心研发。现在做独立开发，技术栈扩展到 Python、Electron、Tauri，也做 AI Agent 开发。比起技术本身，我更着迷「把抽象逻辑变成可感知的体验」——所以做东西之前总先问：谁在用？解决了什么真实问题？现在一边接客户项目练手感，一边孵化 FateMesh（AI 命理智能体平台）、SpaceRoam 这些自己的产品，不赌单一押注。',
...
const en: typeof zh = {
  person: {
    ...
    email: '1192706763@qq.com',
    intro: "I'm LuMaRen, an indie developer in Shanghai. 10 years of development: the first 3 years were web front-end (JavaScript / TypeScript / Node.js / React / Vue), then 3 years as a game front-end engineer at Ximalaya (Phaser.js / Cocos Creator), leading core development for products with tens of millions of daily users. Now I'm independent — my stack has expanded to Python, Electron, Tauri, and AI Agent development. What fascinates me isn't tech for its own sake but turning abstract logic into experiences people can feel. So before building anything I ask: who is it for, and what real problem does it solve? These days I take on client projects while incubating my own products — FateMesh (an AI divination agent platform), SpaceRoam — never betting on a single horse.",
