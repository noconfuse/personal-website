...
const zh = {
  person: {
    ...
    intro: '我是鹿码人，在上海做独立开发。曾任喜马拉雅游戏研发工程师，主导过千万级 DAU 产品的核心研发。比起技术本身，我更着迷「把抽象逻辑变成可感知的体验」——所以做东西之前总先问：谁在用？解决了什么真实问题？现在一边接客户项目练手感，一边孵化 FateMesh、SpaceRoam 这些自己的产品，不赌单一押注。',
...
const en: typeof zh = {
  person: {
    ...
    email: '1192706763@qq.com',
    intro: "I'm LuMaRen, an indie developer in Shanghai — formerly a game engineer at Ximalaya, shipping products for tens of millions of daily users. What fascinates me isn't tech for its own sake but turning abstract logic into experiences people can feel. So before building anything I ask: who is it for, and what real problem does it solve? These days I take on client projects while incubating my own products — FateMesh, SpaceRoam — never betting on a single horse.",
